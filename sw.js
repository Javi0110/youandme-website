...
self.addEventListener('fetch', (event) => {
  ...
  // HTML: network first; solo cachear respuestas OK (evita guardar páginas de error).
  ...
  // Imágenes / video / fuentes: network-first y NUNCA cachear 404/HTML por error.
  // (v3 usaba "cache first" y podía dejar imágenes rotas en caché para siempre.)
  ...
  // Resto de estáticos: network-first, solo cachear OK.
  event.respondWith(
    fetch(event.request)
      .then((response) => {
